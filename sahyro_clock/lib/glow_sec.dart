...
class GlowSeconds extends SecondDot {
...
class _HandPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final position = center + Offset(math.cos(angle), math.sin(angle)) * length/1.25;

    final position2 = center + Offset(math.cos(angle), math.sin(angle)) *length/1.15;
